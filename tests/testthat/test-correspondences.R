...
test_that(populationcorrespondence(geo1, geo2, "id1", "id2", MB = fakeMB, MBcode = "MBID"), equals(one_to_two))
test_that(populationcorrespondence(geo2, geo1, "id2", "id1", MB = fakeMB, MBcode = "MBID"), equals(two_to_one))
